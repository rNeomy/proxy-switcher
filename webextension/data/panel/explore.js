...

{
  ...
  const build = json => {
    ...
    const colors = ['524c84', '606470', '755da3', 'c06c84', '393e46', '446e5c', '693e52', '1d566e', '693e52', 'd95858', 'f27370']
      .sort(() => 0.5 - Math.random());
    Object.entries(json).sort(() => 0.5 - Math.random())
    .slice(0, 3).forEach(([id, {name}], i) => {
